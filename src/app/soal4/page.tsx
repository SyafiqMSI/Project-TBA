...
export default function Soal4() {
  ...
  return (
    <main>
      ...
      <div className="mx-auto px-4 max-w-[850px] py-3 mt-1">
        <Bsoal4 />
        ...
        <div className="gap-2 grid grid-cols-2">
          <div
            className="mt-10 space-y-2 max-w-[369px]"
          ...
          >
            ...
            <div className="mt-5 space-y-2">
              <Label htmlFor="states1" className="states1">
                States
              </Label>
              <Input
                type="text"
            ...
            <div className="space-y-2">
              <Label htmlFor="alphabets1" className="alphabets1">
                Alphabets
              </Label>
              <Input
                type="text"
            ...
            <div className="space-y-2">
              <Label htmlFor="startState1" className="startState1">
                Start State
              </Label>
              <Input
                type="text"
            ...
            <div className="mt-4 space-y-2 ">
              {Object.entries(transitions1).map(([state, value], index) => (
                <div key={index} className="space-y-2">
                  <Label htmlFor={state} className="Transitions">
                    Transitions {state} untuk {alphabets1}
                  </Label>
                  <Input
                    type="text"
                    name={state}
          ...
          <div className="mt-10 space-y-2 max-w-[369px]">
            <h1
              className="font-bold text-2xl mt-4"
              style={{ fontSize: "1.5em" }}
            >
            ...
            <div className="mt-4 space-y-2 ">
              {Object.entries(transitions2).map(([state, value], index) => (
                <div key={index} className="space-y-2">
                  <Label htmlFor={state} className="Transitions">
                    Transitions {state} untuk {alphabets2}
                  </Label>
                  <Input
                    type="text"
                    name={state}
